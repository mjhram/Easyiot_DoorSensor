...
<tr><td colspan="2"><hr></span></td></tr>
<tr><td align="right">NTP State:</td><td><span id="x_sync"></span></td></tr>
<tr><td align="right">Door State:</td><td><span id="x_door"></span></td></tr>
<tr><td align="right">WiFi State:</td><td><span id="x_wifi"></span></td></tr>
<tr><td align="right">MQTT State:</td><td><span id="x_mqtt"></span></td></tr>
...
void send_information_values_html (AsyncWebServerRequest *server)
{
  ...
  String doorStateStr = /*doorEvent.trigger?"Opened":"Closed";*/"NA";
