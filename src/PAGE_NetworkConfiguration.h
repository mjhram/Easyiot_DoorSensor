...
void send_network_configuration_html(AsyncWebServerRequest *server)
{
	...
	if (server->params() > 0 )  // Save Settings
	{
      ...
      Serial.println(server->getParam(i)->name().c_str());
			...
			if (server->getParam(i)->name() == "ip_3") if (checkRange(server->getParam(i)->value())) 	config.IP[3] =  server->getParam(i)->value().toInt();
			if (server->getParam(i)->name() == "nm_0") if (checkRange(server->getParam(i)->value())) 	config.Netmask[0] =  server->getParam(i)->value().toInt();
			if (server->getParam(i)->name() == "nm_1") if (checkRange(server->getParam(i)->value())) 	config.Netmask[1] =  server->getParam(i)->value().toInt();
			if (server->getParam(i)->name() == "nm_2") if (checkRange(server->getParam(i)->value())) 	config.Netmask[2] =  server->getParam(i)->value().toInt();
			if (server->getParam(i)->name() == "nm_3") if (checkRange(server->getParam(i)->value())) 	config.Netmask[3] =  server->getParam(i)->value().toInt();
			if (server->getParam(i)->name() == "gw_0") if (checkRange(server->getParam(i)->value())) 	config.Gateway[0] =  server->getParam(i)->value().toInt();
			if (server->getParam(i)->name() == "gw_1") if (checkRange(server->getParam(i)->value())) 	config.Gateway[1] =  server->getParam(i)->value().toInt();
			if (server->getParam(i)->name() == "gw_2") if (checkRange(server->getParam(i)->value())) 	config.Gateway[2] =  server->getParam(i)->value().toInt();
...
void send_network_configuration_values_html(AsyncWebServerRequest *server)
{
...
//
void send_connection_state_values_html(AsyncWebServerRequest *server){
	String state = "N/A";
	String Networks = "";
